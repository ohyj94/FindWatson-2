				...
				<div class="row">
					<div id="article-middle" class="col-12 mt-2">						
						...
						<div class="row mb-4 p-2">
							...
							<div class="col-12 col-md-9"><input type="text" id="name" name=name value="${dto.hosptName}"></div>
						</div>
						<div class="row mb-4 p-2">
							...
							<div class="row">
							<div class=col-12>
							<input type="text" id="postcode" name=postcode readonly style="width:80%" onclick="sample4_execDaumPostcode()" value="${dto.postcode}">
							<button type=button onclick="sample4_execDaumPostcode()" class="btn btn-sm btn-outline-secondary">찾기</button>
							</div>
							<div class=col-12>
							<input type="text" id="address1" name=address1 readonly value="${dto.address1}">
							<input type="text" id="address2" name=address2 value="${dto.address2}">
							</div>
							</div>
							</div>
						</div>
						<div class="row mb-4 p-2">
							...
							<div class="col-12 col-md-9"><input type="text" id="phone" name=phone value="${dto.phone}"></div>
						</div>
						<div class="row mb-4 p-2">
							<div class="col-12 col-md-3 text-center inputLabel">홈페이지 주소</div>
							<div class="col-12 col-md-9"><input type="text" id="homepage" name=homepage value="${dto.homepage}"></div>
						</div>
						<div class="row mb-4 p-2">
						...
						<div class="row mb-4 p-2">
							...
							<img src="${dto.img}" class="col-12 mb-2" id="imgCon" /> <br /> <a id="imgRemove" href="#">이미지 지우기</a></div>
						</div>
