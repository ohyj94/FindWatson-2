				...
				<div class="row">
					<div id="article-middle" class="col-12 mt-2">
						<div class="row mb-3 p-1 text-center">
							<h3 id="board-top" class="col-auto col-sm-4 m-0">병원 정보 수정</h3>
							<span class="col-auto col-sm-8 mt-2"> <!-- 코멘트를 뭐라 적어야할지 모르겠... -->
							</span>
						</div>
						<form action="${pageContext.request.contextPath}/hosptInfoModify.admin" method="post" id="frm" enctype="multipart/form-data">
							<div class="row line">
								<div class="col-12">
						...
						<div class="row">
							<div class="write-box col-auto col-6 text-center p-1">
								<button id="insert" type="button" class="btn btn-sm btn-outline-secondary">수정</button>
							</div>
							<div class="write-box col-auto col-6 text-center p-1">
