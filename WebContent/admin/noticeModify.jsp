			...
			<div class="col-12 mb-3" id="article">
				<div class="row">
					<div id="article-middle" class="col-12 mt-2">
						...
						<div class="col-12">
							<form action="${pageContext.request.contextPath}/noticeModifyProc.admin" method="post" id=frm>
								<div class="row">							
                    				<div class="col-12 p-1">
                        				<input type="text" class="" id="boardTitle" name="boardTitle" placeholder="제목을 입력하세요" value=${dto.title}>
                    				</div>
								</div>
                				<div class="row">
                    			<div class="col-12 p-1">
							...
							<div class="row mb-2">
                   				<div class="col-12 p-1 text-center">
                       				<button id="writeBtn" type="button" class="btn btn-sm btn-outline-secondary">수정</button>
